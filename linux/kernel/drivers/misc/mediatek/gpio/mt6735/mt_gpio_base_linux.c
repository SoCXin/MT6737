...
{
/* add by jst: change gpio driving current[for rf mipi1 ] begin */
	mt_set_gpio_drv_current(133,3);
	mt_set_gpio_drv_current(134,3);
/* add by jst: change gpio driving current[for rf mipi1 ] end */
