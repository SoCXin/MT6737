...
#else
#define pbm_emerg(fmt, args...)	do{}while(0)
#define pbm_alert(fmt, args...)	do{}while(0)
#define pbm_crit(fmt, args...)	do{}while(0)
#define pbm_err(fmt, args...)	do{}while(0)
#define pbm_warn(fmt, args...)	do{}while(0)
#define pbm_notice(fmt, args...)	do{}while(0)
#define pbm_info(fmt, args...)	do{}while(0)
#endif
