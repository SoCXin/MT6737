...
#define COMPATIABLE_NAME "mediatek,stk3x1x"  //compat stk3x1x
...
static const struct of_device_id alsps_of_match[] = {
	{.compatible = "mediatek,alsps_double"},
	{},
};
#endif
...
static int als_get_data(int* value, int* status)
{
    ...
    *value = report_lux;
	  ...
	  //*value = epl_sensor.als.data.channels[1] /20;   //runyee zhou ALS  sensitivity regulation
...
static int epl_sensor_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
   ...
   // APS_FUN();
   printk("[alsps]epl_sensor_i2c_probe ....\n");
    ...
    //APS_LOG("%s: OK\n", __FUNCTION__);
       printk("[alsps]epl_sensor_i2c_probe OK!!\n");
    return 0;
