...
/**********************************************************
  ...
  *
  *********************************************************/
void  fan5405_hw_register_init(void)
{
   
     fan5405_reg_config_interface(0x06,0x7E); // 
     fan5405_reg_config_interface(0x04,0x79); //CHARGING_FULL_CURRENT 100mA  // CHARGING_CURRENT 1.5A 79  
...
void fan5405_dump_register(void)
{
	...
	for (i = 0; i < fan5405_REG_NUM; i++) {
		...
		printk("fan5405_dump_register====[0x%x]=0x%x \n ", i, fan5405_reg[i]);
