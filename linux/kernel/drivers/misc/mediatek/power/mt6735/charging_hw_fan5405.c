...
const u32 CS_VTH[] = {
  ...
  CHARGE_CURRENT_1050_00_MA,	CHARGE_CURRENT_1150_00_MA, CHARGE_CURRENT_1350_00_MA ,CHARGE_CURRENT_1500_00_MA  // CHARGE_CURRENT_1250_00_MA,  runyee zhou debug
};
...
//add by zhou ,charging debug begin
...
#endif
//add by zhou ,charging debug end 	
	return status;
}
