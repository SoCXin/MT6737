...
extern bool read_eeprom( kal_uint16 addr, char* data, kal_uint32 size);
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//SENSOR_OUTPUT_FORMAT_RAW_Gr, //add zhou
	.mclk = 24,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = read_cmos_sensor(0x0001);
			printk("mn34152 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {				
				printk("mn34152 read sensor_id == imgsensor_info.sensor_id. is ok!!!\n");
				return ERROR_NONE;
			}	
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
        set_mirror_flip(IMAGE_HV_MIRROR);//add zhou
	//hs_video_setting();
