...
static imgsensor_info_struct imgsensor_info = {
   ...
   #endif
        .startx = 80,                    //record different mode's startx of grabwindow
        .starty = 60,                    //record different mode's starty of grabwindow
        .grabwindow_width = 1520,        //record different mode's width of grabwindow
        .grabwindow_height = 1140,        //record different mode's height of grabwindow
...
{
	{ 1520, 1140,	 0,    0, 1520, 1140, 1520,  1140, 0000, 0000, 1520,  1140, 	 0,    0, 1520,  1140}, // Preview 
	{ 1520, 1140,	 0,    0, 1520, 1140, 1520,  1140, 0000, 0000, 1520,  1140, 	 0,    0, 1520,  1140}, // capture 
	{ 1520, 1140,	 0,    0, 1520, 1140, 1520,  1140, 0000, 0000, 1520,  1140, 	 0,    0, 1520,  1140}, // Preview 
	{ 1520, 1140,	 0,    0, 1520, 1140, 1520,  1140, 0000, 0000, 1520,  1140, 	 0,    0, 1520,  1140}, 
	{ 1520, 1140,	 0,    0, 1520, 1140, 1520,  1140, 0000, 0000, 1520,  1140, 	 0,    0, 1520,  1140}};// slim video 
...
/////////////////////////////////////////////////////
	...
	write_cmos_sensor(0x92, 0x02);//03
	write_cmos_sensor(0x94, 0x07);//0e //09
