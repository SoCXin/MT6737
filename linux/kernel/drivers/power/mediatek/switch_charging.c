...
void select_charging_current(void)
{
    ...
    //#if defined(CONFIG_MTK_FAN5405_SUPPORT) //runyee zhou modify select_charging_curret
		#if 0
...
#endif
		printk("[switch_charging]CC_mode_charging current= %d, input current = %d\r\n",  g_temp_CC_value, g_temp_input_CC_value); //zhou printk
