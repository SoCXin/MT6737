  ...
  ifneq (yes, $(strip $(MTK_IN_HOUSE_TEE_SUPPORT)))
    ifneq (yes, $(strip $(TRUSTONIC_TEE_SUPPORT)))
      ifneq (yes, $(strip $(MTK_GOOGLE_TRUSTY_SUPPORT)))
        $(call dep-err-common, Please turn on MTK_IN_HOUSE_TEE_SUPPORT or turn on TRUSTONIC_TEE_SUPPORT or MTK_GOOGLE_TRUSTY_SUPPORT when MTK_SEC_VIDEO_PATH_SUPPORT set as yes)
      endif
    endif
  endif
endif
