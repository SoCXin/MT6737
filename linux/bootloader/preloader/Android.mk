...
$(TARGET_PRELOADER): $(INSTALLED_PRELOADER_TARGET)
	$(hide) $(PRELOADER_DIR)/tools/gen-preloader-img.py $< $@

$(INSTALLED_PRELOADER_TARGET): check-pl-config
droidcore: $(INSTALLED_PRELOADER_TARGET) $(TARGET_PRELOADER)
preloader: $(INSTALLED_PRELOADER_TARGET) $(TARGET_PRELOADER)
pl: $(INSTALLED_PRELOADER_TARGET) $(TARGET_PRELOADER)
