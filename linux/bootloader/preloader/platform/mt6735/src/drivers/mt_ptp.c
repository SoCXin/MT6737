...
struct ptp_devinfo {
	...
	/* M_HW_RES2 10206188*/
#if defined(MACH_TYPE_MT6735) || defined(MACH_TYPE_MT6737T)//D1
...
#if defined(MACH_TYPE_MT6737M) //D2+
		switch (devinfo->SOC_VOLTBIN_550) {
			case 0:
				have_550 = 0;
				det->volt_tbl_bin[0] = MV_TO_VAL(1150) + PTPOD_PMIC_OFFSET;
			...
			case 1:
				have_550 = 1;
				det->volt_tbl_bin[0] = MV_TO_VAL(1100) + PTPOD_PMIC_OFFSET;
				break;
			case 2:
				have_550 = 1;
				det->volt_tbl_bin[0] = MV_TO_VAL(1050) + PTPOD_PMIC_OFFSET;
				break;
			case 3:
				have_550 = 1;
				det->volt_tbl_bin[0] = MV_TO_VAL(1150) + PTPOD_PMIC_OFFSET;
