...
extern kal_uint32 lcm_write_byte(kal_uint8 addr, kal_uint8 value);
extern kal_uint32 lcm_read_byte(kal_uint8 addr, kal_uint8 *dataBuffer); 

static struct mt_i2c_t lcm_i2c;
#define GPIO_65132_ENP   (GPIO64 | 0x80000000)
#define GPIO_65132_ENN   (GPIO63 | 0x80000000)

kal_uint32 lcm_write_byte(kal_uint8 addr, kal_uint8 value)
{
...
kal_uint32 lcm_read_byte(kal_uint8 addr, kal_uint8 *dataBuffer) 
{
    kal_uint32 ret_code = I2C_OK;
    kal_uint16 len;
    *dataBuffer = addr;
...
static void lcm_iic_reg_dump(void)
{
    ...
    lcm_read_byte(0x00,&readbuff[0]);
    MDELAY(10);
    lcm_read_byte(0x01,&readbuff[1]);
    MDELAY(10);    
    lcm_read_byte(0x03,&readbuff[2]);
    MDELAY(10);    
...
LCM_DRIVER otm9608_qhd_dsi_cmd_tps65132_lcm_drv = {
	.name           = "otm9608_qhd_dsi_cmd_tps65132",
