...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xC1, 43, {0x00,0x01,0x06,0x0B,0x10,0x13,0x18,0x1B,0x1F,0x28,0x30,0x3D,0x4A,0x54,0x5B,0x62,0x6B,0x6C,0x74,0x7D,0x88,0x94,0xA1,0xB1,0xBD,0xCC,0xCF,0xD4,0xD8,0xDE,0xE5,0xEB,0xF7,0xFF,0x24,0x17,0x46,0xC6,0x8B,0x4B,0x8C,0xB3,0x40}},

	{0xBD, 1, {0x00}},

	{0xD1, 19, {0x56,0x4B,0x07,0x9A,0x54,0x6B,0x27,0x98,0x04,0x04,0x08,0x04,0x04,0x08,0x80,0xFF,0x00,0x00,0x00}},

	{0xD2, 1, {0x88}},

	{0xD3, 39, {0x00,0x08,0x03,0x03,0x00,0x00,0x04,0x04,0x32,0x10,0x02,0x00,0x02,0x32,0x13,0xC0,0x00,0x00,0x32,0x10,0x08,0x00,0x00,0x30,0x00,0x03,0x03,0x03,0x00,0x03,0x03,0x03,0x03,0x40,0x00,0x00,0x00,0x00,0x10}},
	{REGFLAG_DELAY, 5, {}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_sync_active				= 38; //4--->14
		params->dsi.horizontal_backporch				= 40; //12--->24
		params->dsi.horizontal_frontporch				= 100; //14--->100
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;

		params->dsi.PLL_CLOCK = 438;//232--->200
...
LCM_DRIVER vm5296_fhd_dsi_vdo_hx_lcm_drv = 
{
  .name		= "vm5296_fhd_dsi_vdo_hx",
