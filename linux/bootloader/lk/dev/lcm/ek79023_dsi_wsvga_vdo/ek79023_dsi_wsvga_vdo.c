...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.PLL_CLOCK = 152;//240;//LCM_DSI_6589_PLL_CLOCK_253_5;//LCM_DSI_6589_PLL_CLOCK_240_5;//LCM_DSI_6589_PLL_CLOCK_227_5;//this value must be in MTK suggested table 227_5
