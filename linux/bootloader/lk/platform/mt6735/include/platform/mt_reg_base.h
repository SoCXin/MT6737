...
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 root=/dev/block/mmcblk1p2 init=/sbin/init rootfstype=ext4 rootwait"
#else
//#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 root=/dev/ram vmalloc=496M androidboot.hardware=mt6735 slub_max_order=0 slub_debug=O"
#define COMMANDLINE_TO_KERNEL  "console=ttyMT3,921600n1 console=tty0 root=/dev/mmcblk0p20 rw rootwait loglevel=8"
#endif
